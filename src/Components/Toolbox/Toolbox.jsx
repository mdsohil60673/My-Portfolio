  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Passionate about creating seamless, dynamic, and scalable applications
          with modern web technologies. I combine technical expertise with
              ...
              {techStack
                ...
                .map((tech) => (
                  <div
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.background = `rgba(${parseInt(
                        tech.color.slice(1, 3),
                        16
                      )}, ${parseInt(tech.color.slice(3, 5), 16)}, ${parseInt(
                        tech.color.slice(5, 7),
                        16
                      )}, 0.1)`;
                    }}
                    onMouseLeave={(e) => {
                  ...
                  >
                    <tech.Icon
                      size={24}
                      color={tech.name === "Next.js" ? "#FFFFFF" : tech.color}
                    />
                    <span
                      style={{
                        color: "#ffffff",
                ...
                .map((tech) => (
                  ...
                  >
                    <tech.Icon
                      size={24}
                      color={
                        tech.name === "Express.js" ? "#FFFFFF" : tech.color
                      }
                    />
                    <span
                      style={{
          ...
          {techStack.slice(0, 8).map((tech, index) => (
            ...
            >
              <tech.Icon
                size={32}
                color={
                  tech.name === "Next.js" || tech.name === "Express.js"
                    ? "#FFFFFF"
                    : tech.color
                }
              />
