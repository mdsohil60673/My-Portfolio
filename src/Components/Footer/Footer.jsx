      ...
      content: (
        ...
        >
          {[
            {
              icon: FaGithub,
              url: "https://github.com/mdsohil60673",
              color: "#6366f1",
            },
            {
              icon: FaLinkedin,
              url: "https://www.linkedin.com/in/mdsohil60673",
              color: "#0077b5",
            },
            {
              icon: FaTwitter,
            ...
            {
              icon: FaEnvelope,
              url: "mailto:mdsohil1913051030@gmail.com",
              color: "#ef4444",
            },
          ].map((social) => {
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          width: "100%",
          height: "100%",
          background: `radial-gradient(circle at 25% 15%, rgba(99, 102, 241, 0.15) 0%, transparent 55%), radial-gradient(circle at 75% 85%, rgba(168, 85, 247, 0.15) 0%, transparent 55%), radial-gradient(circle at 15% 75%, rgba(16, 185, 129, 0.1) 0%, transparent 55%), linear-gradient(135deg, rgba(0, 0, 0, 0.85) 0%, rgba(0, 0, 0, 0.95) 100%)`,
          zIndex: 2,
        }}
      />
      <div
        ...
        <div
          ...
          style={{
            ...
            background: `linear-gradient(45deg, ${
              ["#6366f1", "#a855f7", "#10b981", "#f59e0b", "#ef4444"][i % 5]
            }, transparent)`,
            opacity: 0.12,
            top: `${10 + i * 15}%`,
            left: `${10 + i * 15}%`,
      ...
      >
        ...
        >
          ...
          >
            © {new Date().getFullYear()} Md Sohil. All rights reserved.
            <span
              style={{
                display: "block",
                marginTop: "0.5rem",
