    ...
    >
      ...
      <div
        ...
        style={{
          ...
          width: "100%",
          height: "100%",
          background: `radial-gradient(circle at 30% 20%, rgba(236, 72, 153, 0.2) 0%, transparent 50%), radial-gradient(circle at 70% 80%, rgba(99, 102, 241, 0.2) 0%, transparent 50%), radial-gradient(circle at 20% 60%, rgba(168, 85, 247, 0.15) 0%, transparent 50%), linear-gradient(135deg, rgba(0, 0, 0, 0.8) 0%, rgba(0, 0, 0, 0.9) 100%)`,
          zIndex: 2,
        }}
      />
      <div
        ...
        <div
          ...
          onMouseEnter={(e) => {
            if ("ontouchstart" in window || navigator.maxTouchPoints > 0)
              return;
            e.currentTarget.style.transform = "scale(1.4) translateY(-3px)";
