...
const Hero = () => {
  ...
  const handleScroll = useCallback(() => {
    ...
    videoRef.current.style.transform = `translate(-50%, -50%) translateY(${
    ...
    >
      ...
      <div
        style={{
          ...
          width: "100%",
          height: "100%",
          backgroundImage: `linear-gradient(rgba(99, 102, 241, ${
            isMobile ? 0.03 : 0.08
          }) 1px, transparent 1px), linear-gradient(90deg, rgba(99, 102, 241, ${
            isMobile ? 0.03 : 0.08
          }) 1px, transparent 1px)`,
      ...
      >
        ...
        >
          Building seamless, scalable, and user-centric digital experiences
