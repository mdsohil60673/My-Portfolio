...
const Contact = () => {
  ...
  const contactDetails = [
    {
      icon: Mail,
      text: "mdsohil1913051030@gmail.com",
      label: "Email Contact",
      color: "#6366f1",
      href: "mailto:mdsohil1913051030@gmail.com",
    },
    {
      icon: MapPin,
      text: "Delhi-110080, India",
      label: "Location",
      color: "#a855f7",
      href: "https://maps.google.com/?q=Delhi-110080, India",
    },
    {
      icon: Phone,
      text: "+91 9870329118 ",
      ...
      hoverTl
        ...
        .to(
          icon,
          {
            scale: 1.2,
            rotate: 360,
            boxShadow: `0 0 20px ${contactDetails[index].color}60`,
            duration: 0.3,
          },
          0
        )
      ...
      if (item) {
        ...
        if (input && label) {
          ...
          focusTl
            ...
            .to(
              label,
              { color: "#6366f1", scale: 0.9, y: -2, duration: 0.3 },
              0
            );
  ...
  const handleSubmit = (e) => {
    ...
    const submitButton =
      rightSectionRef.current.querySelector(".submit-button");
      ...
      <div className="video-background">
        <video
          ...
          style={{
            ...
            objectFit: "cover",
            filter:
              "brightness(0.7) contrast(1.1) hue-rotate(180deg) saturate(1.2)",
          }}
        >
        ...
        <div className="contact-section">
          <div className="contact-left" ref={leftSectionRef}>
            ...
            <p>
              ...
              exceptional digital experiences that make a real impact. Let's
              discuss your project and explore the possibilities.
            </p>
