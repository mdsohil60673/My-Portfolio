  ...
  const skillsData = [
    {
      ...
      description:
        "Full-stack development with modern technologies including React, Node.js, and cloud platforms. Focused on clean, scalable code architecture.",
      color: "#6366f1",
      delay: 0.2,
    },
    {
      ...
      description:
        "Passionate about emerging technologies and continuous learning. Always exploring new frameworks and development methodologies.",
      color: "#a855f7",
      delay: 0.4,
    },
    {
      ...
      title: "Vision & Goals",
      description:
        "Creating seamless digital experiences that make a real difference. Delivering high-quality, impactful solutions through innovation.",
      color: "#ec4899",
      delay: 0.6,
    },
  ];
          ...
          <div
            ...
            style={{
              ...
              background: `linear-gradient(45deg, ${
                ["#6366f1", "#a855f7", "#ec4899", "#f59e0b", "#10b981"][i]
              }, transparent)`,
              opacity: 0.1,
              top: `${10 + i * 15}%`,
              left: `${5 + i * 20}%`,
      ...
      >
        ...
        >
          ...
          >
            ...
            I focus on delivering seamless user experiences that make a real
            impact.
          </p>
        </div>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  transition:
                    "transform 0.3s cubic-bezier(0.16, 1, 0.3, 1), box-shadow 0.4s ease-out, opacity 1.2s cubic-bezier(0.16, 1, 0.3, 1)",
                  cursor: "pointer",
                  opacity: 0,
