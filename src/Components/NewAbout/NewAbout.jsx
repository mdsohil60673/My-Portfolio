  ...
  useEffect(() => {
    ...
    const initAnimations = () => {
      ...
      mainTimeline
        ...
        .fromTo(
          paraRef.current,
          { opacity: 0, y: isMobile ? 20 : 30, x: isMobile ? 0 : -20 },
          {
            opacity: 1,
            y: 0,
            x: 0,
      ...
      boxesRef.current.forEach((box, index) => {
        if (box) {
          ...
          mainTimeline.fromTo(
            box,
            { opacity: 0, y: isMobile ? 40 : 60, scale: 0.9 },
            {
              opacity: 1,
              y: 0,
              scale: 1,
      ...
      <div className="content-container" ref={contentRef}>
        <div className="title-container1" ref={titleRef}>
          <h1 className="section-title">
            <span className="title-line">What I Do</span>
          </h1>
        </div>
        <div className="about-para1" ref={paraRef}>
          <p>
            ...
            <span className="highlight">My Sql</span>,{" "}
            ...
            <span className="highlight">MongoDB</span>, I bring seamless
            front-to-back solutions. Let's collaborate to craft functional,
            visually stunning, and innovative digital experiences!
          </p>
        </div>
          ...
          {[
            {
              icon: (
                <FaCode
                  className="icon"
                  aria-label="Frontend Development Icon"
                />
              ),
              title: "Frontend Development",
              description:
                "Crafting dynamic and responsive user interfaces with React, HTML, CSS, and JavaScript. Focused on performance and design consistency.",
            },
            {
              icon: (
                <FaServer
                  className="icon"
                  aria-label="Backend Development Icon"
                />
              ),
              title: "Backend Development",
              description:
                "Building robust, secure, and scalable server-side applications using Node.js, Express, and integrating RESTful APIs for seamless data flow.",
            },
            {
              icon: (
                <FaDatabase
              ...
              description:
                "Designing and managing databases with MySQL, PostgreSQL, and MongoDB to ensure secure and efficient data storage solutions.",
            },
          ].map((item, index) => (
            <div
              key={index}
      ...
      <style jsx>{`
        ...
        .section-box {
          ...
          transition: background 0.3s ease, box-shadow 0.3s ease,
            border-color 0.3s ease; /* Adjusted transition */
          cursor: pointer;
          opacity: 0;
          position: relative;
          overflow: hidden;
